...
app.config['MAIL_USERNAME'] = 'majumderaritro2003@gmail.com'  
app.config['MAIL_PASSWORD'] = 'vayh iasr oick lara'  
app.config['MAIL_DEFAULT_SENDER'] = 'majumderaritro2003@gmail.com'  
